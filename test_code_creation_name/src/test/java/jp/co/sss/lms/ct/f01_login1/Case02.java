...
public class Case02 {
	...
	void test02() {
		WebElement loginIdInputElement = webDriver.findElement(By.id("loginId"));
		loginIdInputElement.sendKeys("loginId33");

		WebElement passwordInputElement = webDriver.findElement(By.id("password"));
		passwordInputElement.sendKeys("password33");
		...
		assertThat(errorMessage.getText(), containsString("ログインに失敗しました"));
		getEvidence(new Object() {
